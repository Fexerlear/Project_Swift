...
extension UIView {
    func showTips(_ title: String) {
        EWMBProgressHud.showTextHudTips(message: title, isTranslucent: true)
    }
    func showByLoading(message: String = "加载中...") {
        EWMBProgressHud.showLoadingHudView(message: message, isTranslucent: true)
    }
    func hideByLoading() {
